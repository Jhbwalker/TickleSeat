...
<div class="full-width" style="background-color: black;min-width: 1280px;z-index:100;">
  ...
  <div class="row-fluid">
    ...
    <div class="col-xs-4">
      <ul id="footerFAQ">
        <li style="font-weight:600 !important;font-size:15px;">FAQ</li>
        <li>Is it programmed to say phrases?</li>
        <li>Can this seat tickle men?</li>
        <li>Can I tickle the seat?</li>
        <li>Is this product available to all races?</li>
      </ul>
    </div>
    <div class="col-xs-4">
      <ul id="footerContact">
        <li><h1 style="font-size:15px;margin-top: 0;font-weight:600 !important;margin-bottom:10px;">CONTACT INFO</h1></li>
        <li><i style="margin-right: 15px;font-size:25px;vertical-align: top;" class="fa fa-map-marker"></i> 711 Marylind Ave.<br> <p style="margin:0;margin-left:33px;margin-top:-8px;">Claremond, CA 91711</p></li>
        <li><i style="margin-right: 13px;font-size:23px;vertical-align: top;" class="fa fa-phone"></i> Phone: (909) 621-0406</li>
        <li><i style="margin-right: 15px;font-size:20px;vertical-align: top;"  class="fa fa-fax"></i>Fax: (909) 621-0484</li>
      </ul>
    </div>
  </div>
  <div class="row-fluid"> 
    <p style="text-align: center; color: white;padding-top: 10px; font-size: 10px; " class="light"><i style="font-size:22px;vertical-align: middle;margin-right:20px;" class="fa fa-facebook"></i><i style="font-size:22px;vertical-align: middle;margin-right:50px;" class="fa fa-twitter"></i>SiteName© 2015 | All Rights Reserved | Web Design By <a class="color-white" href="http://www.northvillagegroup.com/"> North Village Group</a>.</p>
  </div>
  </div>
 </div>
</div>
